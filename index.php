        ...
        <div class="content">
            ...
            <div class="tabcontent" id="signup">
                <form method="post" onSubmit="return validateRegister()">
                    ...
                    <input type="text" name="class" id="class"></textarea>
                    <br><br>
					 <label>Upload Profile Pics</label><br>
                    <input type="file" name="img" id="img"></textarea>
                    <br><br>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { // A form is posted
    ...
    if (isset($_POST['register'])) { // Register process
        ...
        // Insert Data
        $sql = "INSERT INTO users(user_firstname, user_lastname, user_nickname, user_password, user_email, user_gender, user_birthdate, user_status, user_about, user_hometown,dept,class,img)
                VALUES ('$userfirstname', '$userlastname', '$usernickname', '$userpassword', '$useremail', '$usergender', '$userbirthdate', '$userstatus', '$userabout', '$userhometown', '$dept', '$class','$img')";
